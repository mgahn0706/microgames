...
캣타워 오르기는 WarioWare 스타일의 초단기 미션을 Next.js와 Canvas로 구현한 리듬형 웹 게임입니다. 매 라운드마다 조작법이 먼저 제시되고, 플레이어는 제한된 박자 안에 과제 제출, 고군분투, 포켓몬 이름 맞히기, 전선 연결, 스타크래프트 이동, 워들 같은 미션을 해결해야 합니다.
...
| 게임                                | 미션                         | 조작                | 박자 | 종류 |
| ----------------------------------- | ---------------------------- | ------------------- | ---- | ---- |
| 고군분투                            | `15개를 모아라!`             | 스페이스바          | 10   | 일반 |
| 과제 제출                           | `제출해라!`                  | 마우스 클릭         | 8    | 일반 |
| 놀러와요 동물의 숲                  | `입력해라!`                  | 한글 키보드         | 12   | 일반 |
| 나나이모                            | `피하고 공격해라!`           | 방향키 + 스페이스바 | 8    | 일반 |
| 닌텐독스                            | `쓰다듬어라!`                | 마우스 드래그       | 8    | 일반 |
| 데이브 더 다이버                    | `사냥해라!`                  | 마우스 홀드         | 8    | 일반 |
| 도블                                | `같은 그림을 찾아라!`        | 마우스 클릭         | 12   | 일반 |
| 도와줘! 리듬 히어로                 | `돌려라!`                    | 마우스 드래그       | 8    | 일반 |
| 레이튼 교수와 이상한 마을           | `같은 모양을 찾아라!`        | 숫자키              | 8    | 일반 |
| 리그 오브 레전드                    | `챔피언을 밴해라!`           | 마우스 클릭         | 12   | 일반 |
| 리듬 세상                           | `제때 멈춰라!`               | 마우스 홀드         | 8    | 일반 |
| 리듬스타                            | `박자에 맞춰 눌러라!`        | 숫자키              | 12   | 일반 |
| 루이지 맨션                         | `숨어든 곳을 찾아라!`        | 마우스 클릭         | 12   | 일반 |
| 루미큐브                            | `타일을 붙여라!`             | 마우스 드래그       | 12   | 일반 |
| 마인크래프트                        | `다이아몬드를 캐라!`         | 마우스 홀드         | 8    | 일반 |
| 매일매일 DS 두뇌 트레이닝           | `계산해라!`                  | 숫자키              | 12   | 일반 |
| 말랑말랑 두뇌교실                   | `블록은 몇 개?`              | 숫자키              | 12   | 일반 |
| 메이플스토리                        | `입력해라!`                  | 한글 키보드         | 12   | 일반 |
| 메이플스토리 룬                     | `순서대로 입력해라!`         | 방향키              | 8    | 일반 |
| 모두의 마블                         | `12를 굴려라!`               | 마우스 홀드         | 8    | 일반 |
| 모여봐요 동물의 숲                  | `찍어라!`                    | 마우스 클릭         | 8    | 일반 |
| 무한의계단                          | `올라가라!`                  | 방향키              | 8    | 일반 |
| 미니게임EX                          | `곰을 잘 봐라!`              | 숫자키              | 16   | 일반 |
| 미니 메트로                         | `노선을 연결해라!`           | 마우스 드래그       | 8    | 일반 |
| 바운스볼                            | `별을 먹어라!`               | 방향키              | 8    | 일반 |
| 배틀그라운드                        | `타이밍에 맞춰 뛰어내려라!`  | 스페이스바          | 12   | 일반 |
| 버블보블                            | `모든 적을 무찔러라!`        | 방향키 + 스페이스바 | 12   | 일반 |
| 별의 커비: 울트라 슈퍼 디럭스       | `빨아들여라!`                | 마우스 홀드         | 8    | 일반 |
| 불과 얼음의 춤                      | `박자에 맞춰 눌러라!`        | 스페이스바          | 8    | 일반 |
| 사과게임                            | `10을 만들어라!`             | 마우스 드래그       | 12   | 일반 |
| 살아남아라! 개복치                  | `새우를 먹어라!`             | 마우스 클릭         | 8    | 일반 |
| 선생님 안 볼 때 춤추기              | `안 볼 때 춤춰라!`           | 스페이스바          | 12   | 일반 |
| 수박게임                            | `수박을 만들어라!`           | 방향키 + 스페이스바 | 8    | 일반 |
| 슈퍼 마리오                         | `코인을 정확히 모아라!`      | 스페이스바          | 8    | 일반 |
| 슈퍼마리오 갤럭시                   | `스타구슬을 모아라!`         | 마우스 드래그       | 12   | 일반 |
| 스네이크                            | `사과를 먹어라!`             | 방향키              | 8    | 일반 |
| 스도쿠                              | `빈칸을 채워라!`             | 숫자키              | 12   | 일반 |
| 스타크래프트                        | `미네랄로 이동시켜라!`       | 마우스 클릭         | 8    | 일반 |
| 십자말풀이                          | `빈칸을 채워라!`             | 한글 키보드         | 8    | 일반 |
| 알까기                              | `밀어내라!`                  | 마우스 드래그       | 8    | 일반 |
| 아이작의 번제                       | `모두 처치해라!`             | 방향키 + 스페이스바 | 12   | 일반 |
| 애니팡                              | `동물을 없애라!`             | 마우스 드래그       | 8    | 일반 |
| 앵그리버드                          | `날려라!`                    | 마우스 드래그       | 8    | 일반 |
...
| 지뢰찾기                            | `터뜨려라!`                  | 마우스 클릭         | 8    | 일반 |
| 지오메트리 대시                     | `가시를 피해라!`             | 스페이스바          | 12   | 일반 |
| 체스                                | `킹을 잡아라!`               | 마우스 드래그       | 8    | 일반 |
| 쿠키 클리커                         | `10개 모아라!`               | 마우스 클릭         | 8    | 일반 |
| 쿠키런: 오븐브레이크                | `달려라!`                    | 방향키 + 스페이스바 | 12   | 일반 |
| 쿠키런: 킹덤                        | `스킬을 발동해라!`           | 숫자키              | 8    | 일반 |
| 크레이지 아케이드                   | `물풍선을 설치해라!`         | 방향키 + 스페이스바 | 12   | 일반 |
| 크롬 공룡게임                       | `점프해라!`                  | 스페이스바          | 8    | 일반 |
| 테트리스                            | `4줄 없애라!`                | 방향키 + 스페이스바 | 12   | 일반 |
| 틱택토                              | `이겨라!`                    | 마우스 클릭         | 12   | 일반 |
| 파피 플레이타임                     | `스캔해라!`                  | 마우스 홀드         | 8    | 일반 |
| 포켓몬 불가사의 던전: 어둠의 탐험대 | `계단으로 가라!`             | 방향키              | 8    | 일반 |
| 포켓몬스터                          | `이 포켓몬의 이름은?`        | 한글 키보드         | 12   | 일반 |
| 포켓몬 카드 게임 Pocket             | `맞는 타입 카드를 내라!`     | 마우스 드래그       | 12   | 일반 |
| 포켓로그                            | `마스터볼을 골라라!`         | 방향키 + 스페이스바 | 8    | 일반 |
| 퐁                                  | `버텨라!`                    | 방향키              | 8    | 일반 |
| 플래피버드                          | `피해라!`                    | 스페이스바          | 8    | 일반 |
| 피아노                              | `연주해라!`                  | 숫자키              | 10   | 일반 |
| 핀볼                                | `떨어뜨리지 마라!`           | 스페이스바          | 8    | 일반 |
| 한컴 타자연습                       | `입력해라!`                  | 한글 키보드         | 12   | 일반 |
| 후르츠 닌자                         | `베어라!`                    | 마우스 드래그       | 8    | 일반 |
| Baba Is You                         | `깃대에 도달해라!`           | 방향키              | 8    | 일반 |
| Fire Boy and Water Girl             | `건너가라!`                  | 방향키              | 8    | 일반 |
| Wii Sports                          | `A와 B를 눌러라!`            | 한글 키보드         | 8    | 일반 |
| 2048                                | `32를 만들어라!`             | 방향키              | 36   | 보스 |
| 동물농장                            | `단어를 거꾸로 써라!`        | 한글 키보드         | 36   | 보스 |
| 버블슈터                            | `버블을 터뜨려라!`           | 스페이스바          | 36   | 보스 |
| 세상에서 제일 어려운 게임           | `끝까지 가라!`               | 방향키              | 50   | 보스 |
| 오징어 게임                         | `결승선을 통과해라!`         | 마우스 홀드         | 36   | 보스 |
| 워들                                | `단어를 맞춰라!`             | 한글 키보드         | 52   | 보스 |
...
- 모든 마이크로게임은 처음부터 도감에 공개됩니다.
- 모든 도감 카드는 선택 즉시 연습할 수 있습니다.
- 도감 카드는 화면 너비에 따라 1~3열 grid로 배치되어 긴 목록의 스크롤을 줄입니다.
...
| 조작 타입        | 기본 조작                                              |
| ---------------- | ------------------------------------------------------ |
| `space`          | 스페이스바 단일 입력으로 화면의 지시를 처리합니다.     |
| `arrowKeys`      | 방향키 단일 입력 또는 연속 입력으로 지시를 처리합니다. |
| `arrowAndSpace`  | 방향키와 스페이스바를 함께 사용합니다.                 |
| `mouseClick`     | 마우스로 화면의 목표 지점을 클릭합니다.                |
| `mouseDrag`      | 마우스를 누른 채 이동해 목표를 조작합니다.             |
| `mouseHold`      | 마우스를 누른 채 유지해 목표를 완료합니다.             |
| `koreanKeyboard` | 한글 IME 입력으로 제시된 문자를 입력합니다.            |
| `numberKeys`     | 숫자키로 화면에 제시된 번호를 입력합니다.              |
...
2. `data/microgames.ts`에 `canvas`, `control`, `beatCount`, `startPrompt`, `microscope`를 등록합니다.
3. `components/game-flow/MicrogameCanvas.tsx`에 canvas renderer를 연결합니다.
