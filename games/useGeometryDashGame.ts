...
const JUMP_AIR_TIME_SECONDS = (Math.abs(JUMP_VELOCITY) * 2) / GRAVITY;
const JUMP_ROTATION_RADIANS = Math.PI * 1.5;
const ROTATION_SPEED = JUMP_ROTATION_RADIANS / JUMP_AIR_TIME_SECONDS;
