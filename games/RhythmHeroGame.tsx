...
const BACKGROUND_SRC = "/games/rhythm-hero/images/background.png";
const SPINNER_SRC = "/games/rhythm-hero/images/spinner.png";
const SPINNER_FRAME = {
  height: "87.25%",
  left: "49.94%",
  top: "53.35%",
...
function RhythmHeroGauge({
  ...
  return (
    <div
      aria-hidden="true"
      className={[
        "pointer-events-none absolute top-0 z-20 h-full w-[14.7%]",
    ...
    >
      {GAUGE_SLOTS.map((slot, index) => {
        ...
        return (
          ...
          >
            <div
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-[#ff6b00] via-[#ffe44d] to-[#73ff5f] shadow-[inset_0_0_12px_rgba(255,255,255,0.5)]"
    ...
    <div className="grid h-screen w-screen place-items-center overflow-hidden bg-black">
      ...
      >
        ...
        <div
          ...
          style={{
            height: SPINNER_FRAME.height,
            left: SPINNER_FRAME.left,
            top: SPINNER_FRAME.top,
            transform: "translate(-50%, -50%)",
            width: SPINNER_FRAME.width,
          }}
        >
          <div
